...
gcc tests/linear_approx_tests.c diagonalization/diagonalize.c math_utils/arctan.c math_utils/lin_cos.c math_utils/lin_sin.c -o bin/linear_approx_tests -Imath_utils -Idiagonalization -lm
