...
gcc int_main.c diagonalization/diagonalize.c math_utils/arctan2.c -o testing -Imath_utils -Idiagonalization -lm -ftree-vectorize -mfpu=neon -mcpu=generic-armv7-a -O3
./bin/testing
