...
gcc int_main.c -S diagonalization/diagonalize.c math_utils/arctan2.c -o bin/testing -Imath_utils -Idiagonalization -lm -ftree-vectorize -mfpu=neon -mcpu=generic-armv7-a -O3
./bin/testing
